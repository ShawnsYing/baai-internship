...
```bash
cd {{WORK_DIR}}
MUSA_VISIBLE_DEVICES={{GPU_ID}} {{PYTHON_PATH}} /home/shuang/baai-internship/auto_gen/fix_worktree_import.py --pytest tests/test_{{OPERATOR}}.py -m {{OPERATOR}} -vs --log-cli-level=DEBUG
```
...
```bash
cd {{WORK_DIR}}
MUSA_VISIBLE_DEVICES={{GPU_ID}} {{PYTHON_PATH}} /home/shuang/baai-internship/auto_gen/fix_worktree_import.py -c "import flag_gems; print(flag_gems.__file__)"
...
```bash
cd {{WORK_DIR}}
MUSA_VISIBLE_DEVICES={{GPU_ID}} {{PYTHON_PATH}} /home/shuang/baai-internship/auto_gen/fix_worktree_import.py --pytest benchmark/test_{{OPERATOR}}.py -m {{OPERATOR}} -vs
```
